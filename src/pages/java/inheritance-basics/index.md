...
So you have successfully created a Car class. But, wait! Aren't Tesla cars supposed to be electric variants? I want an Electric car class, but it also should have the properties of the original `Car` class.
...
See here that the class `ElectricCar` inherits or `extends` the public methods from `Car` class, and it also has its own methods and properties. Cool way to pass on information!
